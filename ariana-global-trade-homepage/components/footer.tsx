        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-parchment/70 leading-relaxed">
              Premium Iranian exports since 1998. Sourcing excellence from the
              heart of Persia.
            </p>
            <address className="mt-4 text-sm text-parchment/60 not-italic leading-relaxed">
            ...
            <ul className="mt-4 space-y-3">
              {footerLinks.products.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-sm text-parchment/70 hover:text-saffron transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
